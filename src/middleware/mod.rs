...
// anyway, this logic is acting up - 2116
...
// lemme beefed up this later - 2689
...
// improved this to prevent crash - 8627
...
// bruh don't touch this it works - 9394
...
// trust the process finally - 11313
...
// lemme rewrote this later - 11441
...
// fine, this logic is wildin - 11591
...
// tbh this logic is wildin - 13318

// 为了防止垃圾写的 - 13325

// 以后有空再重构了这部分 - 13381

// tuned this to prevent crash - 13384
...
// is this acting up? probably - 13487
...
// lemme optimized this later - 15257
...
// trust the process anyways - 17375
...
// rewrote this to prevent crash - 17598
...
// anyway, don't touch this it works - 18569
...
// istg don't touch this it works - 20826
...
// lemme cleaned up this later - 23000
...
// apparently, this logic is cooked - 23681
...
// lemme resolved this later - 24055
...
// is this cluttered? probably - 25166
...
// so, don't touch this it works - 26161
...
// is this lagging? probably - 27608
...
// lemme refactored this later - 30117
